...
library(tidyverse)
library(here)
read.csv(here("data", "birds_and_mammals.csv"))
...
```{r}
filter(critters, Order == "Carnivora")
carnivores <- critters %>% group_by(
```
...
Use code to determine the two species between 2.5e+05 and 3e+05 in adult weight.
